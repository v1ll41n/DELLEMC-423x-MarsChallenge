...
# Global Variables
team_name = 'TheSields'                        # The Name of the Team
team_auth = ''                                  # The Team Authentication Tocken
server_url = 'http://192.168.1.106:8000/api'   # URL of the SERVER API
server_ws = 'ws://192.168.1.106:8000/ws'       # URL of the Sensors Websocket
